...
- Apify spend this session: $3.06 → $3.97 of the $5 free-tier credit (~$1.03 left). Human will provide a fresh account/key when this one runs out.
- Total published listings now 100 (up from 96), still 7 live metro pages (Charleston/Knoxville/Greenville/Pittsburgh all below floor, correctly unpublished).
